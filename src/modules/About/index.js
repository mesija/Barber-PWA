      ...
      <div className="description-box">
        <div className="description">
          ...
          <p>
            ...
            <strong>Тернополі</strong>, ділимося секретами і тонкощами правильного гоління в домашніх умовах небезпечною
            бритвою, ритуалах королівського гоління. Практичні поради про догляд за бородою і вусами, та правильному
            укладанні волосся. Ми хочемо допомогти справжнім чоловікам бути ще більш незалежними і впевненими в собі.
            Вусатий барбер - чоловічий клуб в якому ви не тільки станете краще, але й будете озброєні досвідом наших
            предків. Вусатий барбер - має головну особливість, це перший <strong>барбершоп</strong> в Україні, відкритий
            вусатими майстрами.
          </p>
        </div>
        <ul className="icons">
